...
export class InputFile extends Component {
    ...
    render() {
        ...
        let props = { disabled, type: 'file', style: { display: 'none' }, multiple, onChange: (e) => {e.stopPropagation(); this.change(e) }}
        return <input {...props} />
    }
}
    ...
    render() {
        ...
        return (
            <div className='aio-input-file'>
                ...
                <div className='aio-input-file-name' onClick={(e) => {e.stopPropagation(); DownloadUrl(url, name)}}>
                    {`${minName} (${sizeString})`}
                </div>
                <div className='aio-input-file-icon' onClick={(e) => {e.stopPropagation(); this.remove(index)}}>
